...
public class IdentityDAO {
	 ...
	 * 
	 */
	public IdentityDAO() throws IOException {
	 ...
	 * @param identity
	 */
	public void displayIdentity(Identity identity) {
	...
	public List<Identity> getIdentities() {
		...
		while (this.scanner.hasNext()) {
			...
			readIdentity.setDisplayName(displayName);
			readIdentity.setEmail(email);
			readIdentity.setUid(uid);
